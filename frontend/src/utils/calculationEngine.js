  ...
  groupOrder.forEach((group) => {
    ...
    allocation.itemBreakdown.forEach((entry) => {
      ...
      itemDetails.push({
        ...
        satuanHargaModal: group.barang.satuanHargaModal || 'batang',
  ...
  const manualDetails = manualItems.map((item) => {
    ...
    if (isCustomShape) {
      ...
      return {
        ...
        namaManual: item.namaManual || 'Barang Custom',
        jenisBentuk: 'custom',
        jenisBentukManual: 'custom',
        supplier: item.supplierManual || item.supplier || null,
        supplierManual: item.supplierManual || item.supplier || null,
        jenisBahan: item.jenisBahanManual || 'Custom',
        jenisBahanManual: item.jenisBahanManual || 'Custom',
        beratJenis: null,
        beratJenisManual: null,
        beratbatang: null,
        beratbatangManual: null,
        minWelding: '0',
        minWeldingManual: '0',
        ukuranMentah: null,
        panjangMentah: 0,
        ...
        hargaModal: Math.round(hargaModal),
        hargamodalManual: item.hargamodalManual ? String(item.hargamodalManual) : String(hargaModal),
        hargaJasa: Math.round(hargaJasa),
        hargajasaManual: item.hargajasaManual ? String(item.hargajasaManual) : null,
        hargaManual: item.hargaManual ? String(item.hargaManual) : null,
    ...
    return {
      ...
      namaManual: item.namaManual || 'Barang Manual',
      jenisBentuk: item.jenisBentukManual || 'balok',
      jenisBentukManual: item.jenisBentukManual || 'balok',
      supplier: item.supplierManual || item.supplier || null,
      supplierManual: item.supplierManual || item.supplier || null,
      satuan: satuan,
      satuanBarang: satuan,
      ...
      satuanManual: satuan,
      satuanHargaModal: satuanHargaModal,
      satuanHargaModalManual: satuanHargaModal,
      jenisBahan: item.jenisBahanManual || 'Manual',
      jenisBahanManual: item.jenisBahanManual || 'Manual',
      beratJenis: item.beratJenisManual || null,
      beratJenisManual: item.beratJenisManual || null,
      beratbatang: item.beratbatangManual || null,
      beratbatangManual: item.beratbatangManual || null,
      ...
      diameterManual: item.diameterManual || null,
      ketebalanManual: item.ketebalanManual || null,
      tinggiWFManual: item.tinggiWFManual || null,
      lebarFlangeManual: item.lebarFlangeManual || null,
      ketebalanWebManual: item.ketebalanWebManual || null,
      ketebalanFlangeManual: item.ketebalanFlangeManual || null,
      panjangPlatManual: item.panjangPlatManual || null,
      lebarPlatManual: item.lebarPlatManual || null,
      ketebalanPlatManual: item.ketebalanPlatManual || null,
      jumlahKeperluan,
      volume: item.volume || null,
      hargaSatuan: Math.round(hargaModal),
