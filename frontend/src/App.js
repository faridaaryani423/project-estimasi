...
import JenisMaterial from '@/pages/JenisMaterial';
import Estimasi from '@/pages/Estimasi';
import Penawaran from '@/pages/Penawaran';
import UserManagement from '@/pages/UserManagement';
import Layout from '@/components/Layout';
import { Toaster } from '@/components/ui/sonner';
import { initializeUsers, initializeBarangData, initializeMaterialData } from '@/utils/initializeData';
import '@/App.css';
...
function App() {
  useEffect(() => {
    // Initialize default users, barang, and material data on first load
    initializeUsers();
              ...
              <PrivateRoute>
                <Layout>
                  <Routes>
                    ...
                    <Route path="/jenis-material" element={<JenisMaterial />} />
